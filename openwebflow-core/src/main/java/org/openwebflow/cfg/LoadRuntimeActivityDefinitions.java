...
public class LoadRuntimeActivityDefinitions implements StartEngineEventListener {
  ...
  public void afterStartEngine(ProcessEngineConfigurationImpl conf, ProcessEngine processEngine)
    ...
    for (RuntimeActivityDefinitionEntity entity : _activityDefinitionManager.list()) {
      ProcessDefinitionEntity processDefinition = ProcessDefinitionUtils
          .getProcessDefinition(processEngine, entity.getProcessDefinitionId());
      if (processDefinition != null) {
        RuntimeActivityCreator activitiesCreator = (RuntimeActivityCreator) Class
            .forName(entity.getFactoryName()).newInstance();
  ...
  public void setActivityDefinitionManager(
