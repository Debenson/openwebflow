...
public class TaskDelagationAssignmentHandler implements TaskAssignmentHandler {
  ...
  protected void overwriteCandicateGroupIds(Map<String, Object> groupIdMap,
      Map<String, Object> newUserIdMap, List<DelegationEntity> entries) {
  ...
  protected void overwriteCandicateUserIds(Map<String, Object> userIdMap,
      Map<String, Object> newUserIdMap, Map<String, Object> removeUserIdMap,
