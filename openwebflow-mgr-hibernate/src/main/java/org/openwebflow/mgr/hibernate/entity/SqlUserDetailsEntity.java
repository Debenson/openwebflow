...
public class SqlUserDetailsEntity extends UserDetailsEntitySupport {
  ...
  public String[] getPropertyNames() {
    return new String[] {
        UserDetailsEntity.STRING_PROPERTY_EMAIL,
        UserDetailsEntity.STRING_PROPERTY_MOBILE_PHONE_NUMBER,
        UserDetailsEntity.STRING_PROPERTY_NICK_NAME, UserDetailsEntity.STRING_PROPERTY_USER_ID };
  }
