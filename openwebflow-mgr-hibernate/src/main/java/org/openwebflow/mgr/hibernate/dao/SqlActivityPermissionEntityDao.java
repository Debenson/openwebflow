...
public class SqlActivityPermissionEntityDao extends SqlDaoBase<SqlActivityPermissionEntity> {
  ...
  public SqlActivityPermissionEntity load(String processDefinitionId, String taskDefinitionKey,
      boolean addOrRemove) throws Exception {
    SqlActivityPermissionEntity entity = super.queryForObject(
        "from SqlActivityPermissionEntity where PROCESS_DEFINITION_ID=? and ACTIVITY_KEY=?",
